...
import com.canoestudio.ebwizardrytweaker.crafttweaker.EBWizardryTweakerImbuementAltar;
...
public class CommonProxy {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        CraftTweakerAPI.registerClass(EBWizardryTweakerImbuementAltar.class);
